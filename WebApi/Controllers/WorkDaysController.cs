...
namespace WebApi.Controllers
{
    ...
    public class WorkDaysController : ControllerBase
    {
        ...
        public WorkDaysController(TurneraDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<WorkDay>> PostWorkDay(WorkDay workDay)
        {
            ...
            return CreatedAtAction("GetWorkDay", new { id = workDay.Index }, workDay);
        }
        ...
        {
            return _context.WorkDay.Any(e => e.Index == id);
        }
    }
}
