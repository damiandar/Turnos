...
namespace WebApi.Data
{
    public class AppointmentService
    {
        public AppointmentService()
        {
            ...
            this.CalendarSettings = new CalendarSetting { BookingColor = "Doctors", Calendar = new WebApi.Models.Calendar { Start = "08:00", End = "21:00" }, CurrentView = "Week", Interval = 60, FirstDayOfWeek = 0 };
        }
